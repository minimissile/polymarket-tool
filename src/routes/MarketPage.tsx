          ...
          {market.status === 'loading' ? (
            ...
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <div className="text-lg font-semibold text-slate-900 dark:text-slate-50">{market.data.question ?? slugKey}</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                ...
                <div className="bg-slate-50 dark:bg-slate-900/20 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
                  ...
                  <div className="text-slate-900 dark:text-slate-50 font-mono mt-1">
                    {market.data.endDateIso ?? market.data.endDate ?? '—'}
                  </div>
                </div>
                <div className="bg-slate-50 dark:bg-slate-900/20 rounded-lg border border-slate-200 dark:border-slate-700 p-3">
                      ...
                      {marketOutcomes.map((o, idx) => {
                        ...
                        return (
                          <tr key={`marketOutcome:${idx}`} className="hover:bg-slate-100/60 dark:hover:bg-slate-700/40">
                            ...
                            <td className="px-4 py-2 border-b border-slate-200/60 dark:border-slate-700/50 text-slate-900 dark:text-slate-50 font-mono">
                              {priceText}
                            </td>
                          </tr>
                        )
