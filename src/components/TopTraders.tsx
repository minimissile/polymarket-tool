  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {props.rows.length === 0 ? (
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm" role="region" aria-label="热门交易员表格">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr>
                ...
                <th className="text-left px-4 py-3 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 font-semibold border-b border-slate-200 dark:border-slate-700 whitespace-nowrap sticky top-0 z-20 first:rounded-tl-xl last:rounded-tr-xl">近似成交额</th>
                ...
                <th className="text-left px-4 py-3 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 font-semibold border-b border-slate-200 dark:border-slate-700 whitespace-nowrap sticky top-0 z-20 first:rounded-tl-xl last:rounded-tr-xl"></th>
              </tr>
            </thead>
            <tbody>
              {props.rows.map((row) => (
